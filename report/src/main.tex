...
\usepackage[francais]{babel}	%typographie franÃÂ§aise
\usepackage[utf8]{inputenc}	% accents 8 bits dans le source
\usepackage[T1]{fontenc}	% accents dans le DVI
\usepackage{lmodern}	% Sans cette ligne la typo va ÃÂªtre merdique!!!
...
\fancyhead[L]{ImplÃ©mentation de l'algorythme de Ricart et Agrawala}
\fancyhead[R]{\rightmark}
\fancyfoot{} % clear all footer fields
\fancyfoot[C]{\thepage}

%Gui : problÃ¨me du absence confÃ©rence
%Gui : 
...
\begin{document}
	...
	% puis vient la table des matiÃÂ¨res
	%\pagenumbering{roman}
%	\listoffigures
%\pagebreak
 %	\tableofcontents
...
% 	\fancyhead{}
% 	\fancyhead[R]{Rapport de Design ÃÂlectronique}
% 	\input{./intro.tex}
% 	\pagebreak
	\input{partie1.tex}
\pagebreak
...
%}\item }{\end{list}}
%IdÃ©e de dÃ©veloppement partir de Blancarde, pour arrivÃ©e Ã  l'IVPico, ou l'inverse Ã  voir. A l'oral ce serait certainement mieux, tellement Blancarde version installation est simple par rapport Ã  l'autre.