...
\paragraph{} Nous nous sommes fixés un autre objectif, celui d'apprendre à utiliser git, pour les raisons évoqué en \ref{gitPar} subversion ne nous convenait pas, mais nous ne connaissions pas vraiment git pour autant, néanmoins après avoir visionner une conférence de Linus Torvalds  %TODO orthographe
...
\subparagraph{}La comparaison de fichiers sous git est un peu particulière, contrairement à svn qui se base sur la date du fichier, git se base sur un checksum du fichier pour la comparaison. Il se sert en fait d'une base interne contenant l'intégralité des checksums des fichiers en fonction du numéro du commit correspondant.
...
\subparagraph{}L'utilisation conjuguée de git et de github nous permet donc :
\begin{itemize}
